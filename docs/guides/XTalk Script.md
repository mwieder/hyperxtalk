...
We recommend you start by taking a look at [sample stacks](https://livecode.com/resources/). There is a wide variety of
...
The following versions of macOS:

- 10.14 (Mohave) through macOS 26 (Tahoe)
...
Other resources include Sample Stacks, an online repository of
user-contributed stacks, User forums, and the resources pages.
